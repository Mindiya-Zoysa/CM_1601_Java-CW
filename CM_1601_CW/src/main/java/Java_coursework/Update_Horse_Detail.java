...
public class Update_Horse_Detail implements Initializable {
        ...
        try{
            ...
            if (Adding_Horse.WholeHorses.size()<20) {
                ...
                if (Wins <= TotalRace) {
                    ...
                    if (Group.equals("A")){
                        if (countA<5){
                            HorseList( Name, Jockey, Age, Breed, raceRecord, Group);
                            resetFields();
            ...
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setTitle("Group is not selected");
            alert.setHeaderText(null);
            alert.setContentText("Select a Group that u missed ");
            alert.showAndWait();
    ...
    private void HorseList(String Name , String Jockey, int Age ,String Breed,
                           String raceRecord,String Group){
